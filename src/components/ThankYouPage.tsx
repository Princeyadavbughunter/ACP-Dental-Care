    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <div className="p-6 md:p-8">
          <div className="mb-8">
            <h2 className="text-center text-xl font-semibold text-gray-800 mb-6">Our Experts Waiting to Serve You</h2>
            <div className="grid md:grid-cols-2 gap-8 justify-center">
              {/* Dr. Ashish */}
              <div className="flex flex-col items-center text-center">
                <div className="w-32 h-32 relative rounded-full overflow-hidden border-4 border-[#b8904a] shadow-md mb-3">
                  <Image
                    src="/images/doctor/dr.ashis.jpeg"
                    alt="Dr. Ashish Chhajlani Jain"
                    fill
                    className="object-cover"
                  />
                </div>
                <h3 className="text-lg font-bold text-gray-900">Dr. Ashish Chhajlani Jain</h3>
                <p className="text-[#01659e] font-medium text-sm">M.D.S. Endodontist</p>
                <p className="text-gray-500 text-xs">Root Canal Specialist</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                <div className="w-32 h-32 relative rounded-full overflow-hidden border-4 border-[#b8904a] shadow-md mb-3">
                  <Image
                    src="/images/doctor/drcharmee.jpg"
                    alt="Dr. Charmee Padaliya Chhajlani"
                    fill
                    className="object-cover"
                  />
                </div>
                <h3 className="text-lg font-bold text-gray-900">Dr. Charmee Padaliya Chhajlani</h3>
                <p className="text-[#01659e] font-medium text-sm">B.D.S., M.S. Implantology</p>
                <p className="text-gray-500 text-xs">Oral Implantology & Rehabilitation</p>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="https://wa.me/918866697133?text=Hi,%20I%20just%20submitted%20an%20appointment%20request.%20I%20would%20like%20to%20know%20more%20about%20the%20treatment."
              target="_blank"
